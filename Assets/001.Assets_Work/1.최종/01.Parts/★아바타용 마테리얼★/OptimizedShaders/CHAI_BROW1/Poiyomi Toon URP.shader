Shader "Hidden/Locked/.poiyomi/Poiyomi Toon URP/ce2c63dee84c2f942a01fa5f32800313"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				float4 outlineColor = float4(0.006628771,0.002620976,0.002176771,1);
				#ifdef POI_AUDIOLINK
