Shader "Hidden/Locked/.poiyomi/Poiyomi Toon URP/a8ad82a4391a5254cb9af2ea84552f94"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void PoiCalculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				if (1.0)
				{
					lns.x = poiEdgeNonLinearNoSaturate(lightMap.x, 0.49995, 0.00009998679 * blurMap.r);
					lns.y = poiEdgeNonLinearNoSaturate(lightMap.y, 0.0, 0.0 * blurMap.g);
					lns.z = poiEdgeNonLinearNoSaturate(lightMap.z, 0.25, 0.1 * blurMap.b);
					lns.w = poiEdgeNonLinearNoSaturate(lightMap.x, 0.49995, 0.00009998679 * blurMap.r, 0.0);
				}
				else
				{
					lns.x = poiEdgeLinearNoSaturate(lightMap.x, 0.49995, 0.00009998679 * blurMap.r);
					lns.y = poiEdgeLinearNoSaturate(lightMap.y, 0.0, 0.0 * blurMap.g);
					lns.z = poiEdgeLinearNoSaturate(lightMap.z, 0.25, 0.1 * blurMap.b);
					lns.w = poiEdgeLinearNoSaturate(lightMap.x, 0.49995, 0.00009998679 * blurMap.r, 0.0);
				}
				#if defined(PROP_SHADOWBORDERMASK) || !defined(OPTIMIZER_ENABLED)
