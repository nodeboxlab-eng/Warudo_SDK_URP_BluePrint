...
// This file was auto-generated by uMod Build Engine 2.0 for 'Node68_DevKit'

#Requirements

The requirements for 'Node68_DevKit' are as follows:
...
The content types fhat can be included for '%Node68_DevKit' are as follows:

	Scene mods: Yes
	Prefab mods: Yes
	Script mods: Yes

The parent folder of this file called 'Node68_DevKit' is known as the 'Mod Folder' and this is where all mod content should be placed in order for it to be exported. 
