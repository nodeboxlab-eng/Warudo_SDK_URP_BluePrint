Shader "PotaToon/Toon"
{
    Properties
    {
        ...
        [HideInInspector] _PotaToonShaderMode("Shader Mode", Int) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include_with_pragmas "./PotaToonDitherFadeForwardKeywords.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Core.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl"
            #define _USE_DITHER_FADE 1
            #include "./PotaToonInput.hlsl"
        ...
        Pass
        {
            ...
            #include_with_pragmas "./PotaToonDitherFadeOutlineKeywords.hlsl"
            #define _USE_DITHER_FADE 1
            #include "./PotaToonInput.hlsl"
            #include "./PotaToonOutlinePass.hlsl"
